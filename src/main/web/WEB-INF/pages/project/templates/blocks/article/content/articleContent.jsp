...
<h4>"Neque porro quisquam est qui dolorem ipsum quia dolor sit
	amet, consectetur, adipisci velit..."</h4>
<h5>"Il n’y a personne qui n’aime la souffrance pour elle-même, qui
	ne la recherche et qui ne la veuille pour elle-même…"</h5>
<div>
	<div class="lc">
		<h2 class="what">
			<span>Qu'est-ce que le Lorem Ipsum?</span>
		</h2>
		<p>
			Le <strong>Lorem Ipsum</strong> est simplement du faux texte employé
			...
			texte pour réaliser un livre spécimen de polices de texte. Il n'a pas
			fait que survivre cinq siècles, mais s'est aussi adapté à la
			bureautique informatique, sans que son contenu n'en soit modifié. Il
			a été popularisé dans les années 1960 grâce à la vente de feuilles
...
<div style="clear: both;">
	<div class="lc">
		...
		<p>L'extrait standard de Lorem Ipsum utilisé depuis le XVIè siècle
