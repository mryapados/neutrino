...
public class BackOfficeListController extends AbtractController {
	@Autowired
	...
	public ModelAndView view(@ModelAttribute("type") String type, Pageable pageRequest) throws JspException   {
