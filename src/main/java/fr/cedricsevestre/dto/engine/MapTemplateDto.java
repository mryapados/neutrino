...
public class MapTemplateDto implements Serializable {
	...
	// On ne récupère pas la position parcequ'on veut des éléments 
	// provenant de la position qu'on connait déjà et parceque ça 
	// fait une boucle infinie car chaque position à une liste de 
